...
?><?php
 ...
 $system=new system();
 $system->setPath('packages','./lib/kernel/packages');
 $system->setPath('interfaces','./lib/kernel/interfaces');
 $system->setPath('abstractions','./lib/kernel/abstractions');
 $system->setPath('errors','./lib/kernel/errors');
...
<html>
 ...
 <body>
 <h1>InvisibleSystems Inviskernel <span style='color:#FF0000;'>0.5A</span></h1>
