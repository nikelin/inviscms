									            ...
									            <form action='' method='post'>
													...
													<div class='position' id="position_<?=$row['product'];?>" style='display:none;margin:0;padding:0;background-color:#EEEEFF;width:100%;'>
														...
														<div class='row' style='margin:0;padding:0;'>
															...
															<span class='col' style='width:55%;'>
																<input type='text' name='title' value='<?=rawurldecode($row['title']);?>' style='width:100%;'/>
												            </span>
														</div>
														<div class='row'>
															<span class='col' style='width:35%;'>
														...
														<div class='row'>
												        	<span class='col' style='width:100%;'>
																<textarea name='description' style='width:100%;'><?=rawurldecode($row['description']);?></textarea>
															</span>
												        </div>
												        ...
												        <div class='row' style='font-size:16px;'>
												            <strong>Теги</strong>: 
												            <input style='width:100%;' type='text' name='tags' value='<?=rawurldecode($row['tags']);?>'/>
												        </div>
