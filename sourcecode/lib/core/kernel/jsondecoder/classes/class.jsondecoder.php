...
class jsondecoder
{
     ...
     * @return void
     */
    function __construct($source="", $objectDecodeType=Zend_Json::TYPE_ARRAY)
    {
        // Set defaults
        $this->_source       = $source;
    	...
    	$this->_offset       = 0;
    	$this->init($source,$objectDecodeType);
    }
	
	public function init($source, $decodeType=Zend_Json::TYPE_ARRAY){
